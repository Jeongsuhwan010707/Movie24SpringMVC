    ...
    <body>
        <div>
            <header>
                ...
                <div id="title_right">
                    <ul>
                        <li><a href="/movie24/help.do"><img src="/resources/images/free-icon-operator-8111794.png" alt=""></a></li>
                        <li><a href=""><img src="/resources/images/free-icon-help-round-button-61079.png" alt=""></a></li>
                        
                        <div id="login">
                        <c:if test="${sessionScope.memberId ne null }">
	                        <li><a href="/movie24/myPage.do?member-id=${memberId}"><img src="/resources/images/free-icon-user-5264565.png" alt=""></a></li>
						...
						<c:if test="${memberId eq null }">
                            ...
                            <li><a href="/movie24/login.do"><img src="/resources/images/free-icon-lock-2089784.png" alt="로그인"></a></li>
                        </c:if>
                        </div>
                    </ul>
                </div>
